...
screen main_menu():
    ...
    frame:
        ...
        vbox:
            ...
            textbutton "Dialoguer" action Start() xalign 0.5:
                text_size 73  # increase font size
                padding (10, 10)
                background None  # optional, removes button background if you want clean text

            textbutton "Quitter" action Quit(confirm=True) xalign 0.5:
                text_size 73
                padding (10, 10)
                background None
